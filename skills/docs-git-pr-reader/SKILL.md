...
- **docs-jira-reader**: Combine JIRA issue context with Git code changes
- **docs-jira-writer**: Generate release notes from JIRA + Git data, then push back to JIRA
