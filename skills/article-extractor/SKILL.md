...
```bash
uv run --script scripts/article_extractor.py --url "https://example.com/page"
```

**Extract with specific output format:**
```bash
uv run --script scripts/article_extractor.py --url "https://example.com/page" --format markdown
```

**Save to file:**
```bash
uv run --script scripts/article_extractor.py --url "https://example.com/page" --output article.md
```

**Extract with custom article selector:**
```bash
uv run --script scripts/article_extractor.py --url "https://example.com/page" --selector "article.main-content"
```
...
uv run --script scripts/article_extractor.py \
