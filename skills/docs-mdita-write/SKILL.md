...
```
/docs-mdita-write                           # Interactive: ask what to write
/docs-mdita-write concept <description>     # Write a concept topic
/docs-mdita-write task <description>        # Write a task topic
/docs-mdita-write reference <description>   # Write a reference topic
/docs-mdita-write map <description>         # Write a Markdown DITA map
/docs-mdita-write convert <file>            # Convert existing Markdown DITA to DITA XML
```
