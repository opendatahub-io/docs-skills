...
Markdown templates for human-readable output files produced by docs-learn-code steps.
...
- Query the codebase: `/docs-skills:docs-query-code "your question" --repo <REPO_PATH>`
