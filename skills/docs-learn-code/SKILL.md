...
```
/docs-skills:docs-learn-code /path/to/repo
/docs-skills:docs-learn-code https://github.com/user/repo
/docs-skills:docs-learn-code /path/to/repo --exclude "test/*" "vendor/*"
```
