...
Usage:
    python3 <skill-dir>/scripts/jira_reader.py --issue INFERENG-5233
    python3 <skill-dir>/scripts/jira_reader.py --issue INFERENG-5233 --include-comments
    python3 <skill-dir>/scripts/jira_reader.py --jql "project=INFERENG AND fixVersion='3.4'"
    python3 <skill-dir>/scripts/jira_reader.py --graph INFERENG-5233
"""
